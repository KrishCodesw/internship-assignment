      ...
      <div className="text-center space-y-8 max-w-md">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full px-5 py-2.5 bg-gray-900 text-white rounded-md font-medium hover:bg-gray-800 transition-colors duration-150"
          >
            Get Started
          </button>
          <button
            onClick={() => router.push('/login')}
            className="w-full px-5 py-2.5 text-gray-700 rounded-md font-medium hover:bg-gray-50 transition-colors duration-150"
          >
            Sign In
          </button>
        </div>
